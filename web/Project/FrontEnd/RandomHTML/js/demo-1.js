(function() {
    ...
    function initHeader() {
        ...
        for(var i in points) {
            var c = new Circle(points[i], 2+Math.random()*2, 'rgba(255,71,73,1.0)');
            points[i].circle = c;
        }
    }
    ...
    function drawLines(p) {
        ...
        for(var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(255, 21, 71,'+ p.active+')';
            ctx.stroke();
        }
    }
    ...
    function Circle(pos,rad,color) {
        ...
        this.draw = function() {
            ...
            ctx.fillStyle = 'rgba(255, 21, 41,'+ _this.active+')';
            ctx.fill();
        };
    }
